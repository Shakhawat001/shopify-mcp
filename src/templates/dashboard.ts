/**
 * Dashboard Template
 * Renders the main dashboard HTML for the Shopify MCP Server
 */
...
export function renderDashboard(params: DashboardParams): string {
  const { host, shop, apiKey, isAuthorized } = params;
